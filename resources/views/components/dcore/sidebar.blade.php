<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-lin beep beep-sidebar" href="https://demo.getstisla.com/components-article.html">Data Project</a></li> 
            </ul>
            </li>
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="{{route('page')}}" class="btn btn-primary btn-lg btn-block btn-icon-split">
              <i class="fas fa-plus"></i> Create Pages
            </a>
          </div>        
        </aside>
      </div>
